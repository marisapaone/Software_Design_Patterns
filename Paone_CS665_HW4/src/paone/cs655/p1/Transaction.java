...
//Component Class (used in previous homeworks)
public abstract class Transaction {
    ...
    public Transaction(Date transactionDate,  int transactionAmount, Customer transactionOwner) {
    ...
    public void print(Account account) {
        //This print was commented out to match sample output more closely.
       /* if (account != null) {
